    ...
    <a href="logout.php"><button class="btn btn-danger pull-right" > <span class="glyphicon glyphicon-log-out" class="navbar-link"></span>Cerrar sesión</button></a>
      ...
      <div class="main-content">
        ...
        <div class="menu">
          ...
          <form id="formCategoria" class="form-horizontal form-label-left" action="../Controlador/UpdateProveedor.php" method="POST">

            <span class="section"><h2>Editar Proveedor</h2></span>
