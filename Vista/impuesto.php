                                      ...
                                      <div class="x_content">
                                        ...
                                        <table class="table table-striped table-bordered">
                                          ...
                                          <tbody>
                                                   ...
                                                   <?php 
                                               $queryImpuesto="SELECT * FROM impuesto";
                                               $getAll = mysqli_query($con,$queryImpuesto);
                  ...
                  <div class="col-md-6 col-sm-12 col-xs-12 ">
                    <div class="x_panel">
                      ...
                      <div class="x_content">
                        ...
                        <form id="formImpuesto"class="form-horizontal form-label-left" action="../Controlador/CategoriaControlador.php" method="POST" id="formCategoria">
