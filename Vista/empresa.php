                                        ...
                                        <table id="tbCategoria" class="table table-striped table-bordered dt-responsive nowrap">
                                          ...
                                          <tbody>
                                                   ...
                                                   <?php
                                                     ...
                                                     $queryUsuarios="SELECT * FROM empresa";
                                                   ...
                                                   <tr>
                                                     ...
                                                     <td>
                                                          ...
                                                          <a class="btn btn-info btn-xs" href="modificarEmpresa.php?id=<?php echo $row ['idEmpresa'];?>">Editar
                  ...
                  <div class="col-md-6 col-sm-12 col-xs-12 ">
                    <div class="x_panel">
                      ...
                      <div class="x_content">
                        ...
                        <form class="form-horizontal form-label-left" action="../Controlador/EmpresaControlador.php" method="POST" id="formCategoria">

                             <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Nombre <span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                          <input id="nombreEmpresa" class="form-control col-md-7 col-xs-12"  data-validate-length-range="10" data-validate-words="2" name="nombreEmpresa"  type="text">
                                        </div>
                                      </div>
        ...
        message: 'El campo no es válido',
                validators: {
                    ...
                    stringLength: {
                        min: 5,
                        max: 16,
                        message: 'EL campo debe estar entre 5-16 caracteres'
                    },
                    regexp: {
                        regexp: /^[0-9]+$/,
