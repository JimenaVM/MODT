                        ...
                        ?>
                                    ...
                                    <div class="item form-group">
                                      ...
                                      <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="nombreProducto" class="form-control col-md-7 col-xs-12" data-validate-length-range="30" data-validate-words="2" name="nombreProducto"   type="text" value="<?php echo $DATA['nombre']; ?>">
                                      </div>
                                    </div>
                                     <div class="item form-group">
                                    ...
                                    <div class="item form-group">
                                      ...
                                      <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" id="codigoProd" name="codigoProducto"  class="form-control col-md-7 col-xs-12" value="<?php echo $DATA['codigo']; ?>">
                                      </div>
                                    </div>
                                     <div class="item form-group">
