  ...
  <aside class="sidebar-left-collapse">
    ...
    <div class="main-content">
          ...
          <div class="menu">
             ...
             <!-- FORM ACTUALIZAR -->
                      <form id="formCategoria"class="form-horizontal form-label-left" action="../Controlador/UpdateCategoria.php" method="POST">
                        <span class="section"><h2>Editar Categoria</h2></span>
                      ...
                      <?php }?>
                        <div class="item form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <input id="nombreCat" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="nombreCat"  type="text" value="<?php echo $DATA['descripcion']; ?>">
                          </div>
                        </div>
                        ...
                        <div class="item form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="hidden" id="telefono" name="id"  data-validate-length-range="8,20" class="form-control col-md-7 col-xs-12" value="<?php echo $DATA['idCategoria']; ?>">
                          </div>
                        </div>
